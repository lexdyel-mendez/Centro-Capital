...
const About = () => {
    return (
      ...
      <p>
        Some of the features you can expect from our platform include:
      </p>
      <ul>
        <li>
          Interactive data visualization: Our team has carefully
          crafted intuitive and engaging visualizations to help users explore
          and analyze data more effectively.
        </li>
        <li>
          Data-driven insights: Our team strives to provide 
          up-to-date, data-driven insights, ensuring that our platform
          remains a reliable source of information.
        </li>
        <li>
          Customizable experience: Users can easily customize their experience
        ...
        <li>
          Continuous updates: As our database grows, our team remains committed
      ...
      <ul>
        <li>adean.colon@upr.edu</li>
        <li>juan.diaz28@upr.edu</li>
        <li>lexdyel.mendez@upr.edu</li>
      </ul>
      <p>
